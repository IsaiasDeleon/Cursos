document.querySelector(".sliderFirst") && tns({
...
document.querySelector(".sliderSecond") && tns({
...
document.querySelector(".sliderThird") && tns({
...
document.querySelector(".sliderFourth") && tns({
...
document.querySelector(".sliderTestimonial") && tns({
...
document.querySelector(".sliderTestimonialSecond") && tns({
...
document.querySelector(".product") && tns({
    container: "#product",
    items: 1,
    startIndex: 1,
...
document.querySelector(".sliderTestimonialThird") && tns({
