    ...
    <ul class="navbar-nav flex-column" id="sideNavbar">
        ...
        <li class="nav-item">
            ...
            <div id="navCMS" class="collapse  show " data-bs-parent="#sideNavbar">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link  active " href="../../pages/dashboard/admin-cms-overview.html">Overview</a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        ...
                        <div id="navprojectSingle" class="collapse " data-bs-parent="#navProject">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link  active " href="../../pages/dashboard/project-overview.html">Overview</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div id="navproduct" class="collapse " data-bs-parent="#navProduct">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="../../pages/dashboard/ecommerce/product-grid-with-sidebar.html">
                                        Grid Sidebar
                                    </a>
                                </li>
                                <li class="nav-item">
