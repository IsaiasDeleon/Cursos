                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <h1 class="fw-bold mt-2 mb-0 h2">12,698</h1>
                                        <p class="text-success fw-semibold mb-0">
                                            <i class="fe fe-trending-up me-1"></i>
                                            4.6%
                                        </p>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <h1 class="fw-bold mt-2 mb-0 h2">2.65K</h1>
                                        <p class="text-danger fw-semibold mb-0">
                                            <i class="fe fe-trending-down me-1"></i>
                                            4.6%
                                        </p>
                                ...
                                <div class="mt-4 d-flex justify-content-center">
                                    ...
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item mx-3">
                                            <h5 class="mb-0 d-flex align-items-center lh-1">
                                                <span class="me-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-square-fill text-danger" viewBox="0 0 16 16">
                                                        <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z">
                                                    </svg>
                        ...
                        <div class="card h-100">
                            ...
                            <table class="table mb-0 table-hover table-centered">
                                <tbody>
                                    <tr>
                                        <td>
                                            <img src="../../assets/images/browser-svg/chrome.svg" alt="" class="me-2">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="../../assets/images/browser-svg/firefox.svg" alt="" class="me-2">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="../../assets/images/browser-svg/brave.svg" alt="" class="me-2">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="../../assets/images/browser-svg/safari.svg" alt="" class="me-2">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="../../assets/images/browser-svg/ie.svg" alt="" class="me-2">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="../../assets/images/browser-svg/opera.svg" alt="" class="me-2">
